...
void vcSettings_LoadBranding(vcState *pState)
{
  ...
  udStrcpy(pState->branding.supportURLLogin, branding.Get("supportURLLogin").AsString("fffix this beforePR"));
  udStrcpy(pState->branding.supportURLConverting, branding.Get("supportURLConverting").AsString("fffix this beforePR"));
